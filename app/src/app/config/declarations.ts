...
children: [{path: 'vehicle', component: vehiclechecklistComponent},{path: 'extension', component: visaextensionComponent},{path: 'guesthouse', component: guesthousechecklistComponent},{path: 'transport', component: transportrequestComponent}]},{path: 'login', component: loginComponent},{path: 'unauthorized', redirectTo: '/login', pathMatch: 'full'},{path: 'admin', component: adminComponent},{path: '', redirectTo: '/guesthouse', pathMatch: 'full'},{path: '**', component: PageNotFoundComponent}]
